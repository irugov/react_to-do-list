...
function TaskList({tasks}) {  
  ...
  //Хуки для сворачивания/разворачивания списков задач
  const [activeIsHidden, setActiveIsHidden] = useState(false);
  const [completedIsHidden, setCompletedIsHidden] = useState(true);

  useEffect(() => {}, []);

	return <main className="flex flex-col h-screen text-white">
        <header className="sticky top-0 z-50 px-[20px] py-[15px] bg-[#1c1c1c]">
          ...
          <section className="grow bg-[#1c1c1c]">  
            <section>
                <span className="flex items-center gap-[7.5px] pl-[20px] cursor-pointer">
                      ...
                      <g id="Page-1" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
                          <g id="Dribbble-Light-Preview" transform="translate(-305.000000, -6679.000000)" fill="#535358">
                              <g id="icons" transform="translate(56.000000, 160.000000)">
                                  ...
                                  id="arrow_right-[#336]"
                                  {...( !activeIsHidden ? {transform: "translate(254.000000, 6529.000000) rotate(90) translate(-254.000000, -6529.000000)"} : {} )}></path>
                              </g>
                          </g>
                      </g>
                  </svg>
                  <h2 className="text-[12px] font-bold" onClick={ () => setActiveIsHidden(!activeIsHidden) }>Активно</h2>
                      ...
                      <g id="Page-1" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
                          <g id="Dribbble-Light-Preview" transform="translate(-305.000000, -6679.000000)" fill="#535358">
                              <g id="icons" transform="translate(56.000000, 160.000000)">
                                  <path d="M249.365851,6538.70769 L249.365851,6538.70769 C249.770764,6539.09744 250.426289,6539.09744 250.830166,6538.70769 L259.393407,6530.44413 C260.202198,6529.66364 260.202198,6528.39747 259.393407,6527.61699 L250.768031,6519.29246 C250.367261,6518.90671 249.720021,6518.90172 249.314072,6519.28247 L249.314072,6519.28247 C248.899839,6519.67121 248.894661,6520.31179 249.302681,6520.70653 L257.196934,6528.32352 C257.601847,6528.71426 257.601847,6529.34685 257.196934,6529.73759 L249.365851,6537.29462 C248.960938,6537.68437 248.960938,6538.31795 249.365851,6538.70769" 
                                  id="arrow_right-[#336]"
                                  {...( !completedIsHidden ? {transform: "translate(254.000000, 6529.000000) rotate(90) translate(-254.000000, -6529.000000)"} : {} )}></path>
                              </g>
                          </g>
                      </g>
                  </svg>
                  <h2 className="text-[12px] font-bold" onClick={ () => setCompletedIsHidden(!completedIsHidden) }>Выполнено</h2>
